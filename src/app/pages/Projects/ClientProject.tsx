  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[1200px] mx-auto mb-20">
      {projects.map((project) => (
        <div key={project._id} className="rounded-lg overflow-hidden shadow-md bg-white transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-medium text-[#464644]">{project.title}</h3>
            </div>
            <p className="text-sm text-[#727270] mb-6 line-clamp-3">{project.body}</p>
